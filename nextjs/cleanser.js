...
export const mentionRegex = (WEB_BASE_URL = process.env.NEXT_PUBLIC_WEB_BASE_URL) =>
    new RegExp(`^<a href="${(WEB_BASE_URL || location.origin).split('/').join('\\/')}\\/@([^"]+)">@\\1<\\/a>$`);

export const cleanseHTML = (html = '', WEB_BASE_URL = process.env.NEXT_PUBLIC_WEB_BASE_URL) => {
